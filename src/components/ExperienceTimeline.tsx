    ...
    <section id="experience" className="relative py-24">
      <div className="mx-auto max-w-6xl px-5 sm:px-8">
        ...
        <div className="relative mt-14 pl-8 sm:pl-10">
          <div className="absolute left-[7px] top-0 h-full w-px bg-gradient-to-b from-indigo-500/50 via-slate-300 to-transparent dark:via-slate-800 sm:left-[15px]" />

          <div className="space-y-10">
            {experience.map((role, i) => (
              <Reveal key={`${role.company}-${role.title}`} delay={i * 0.05}>
                <div className="relative">
                  <span className="absolute -left-8 top-5 h-3.5 w-3.5 rounded-full border-2 border-indigo-600 bg-slate-50 dark:border-indigo-400 dark:bg-ink sm:-left-10" />
                  <div className="glass p-6 transition-colors duration-300 hover:border-slate-400 dark:hover:border-slate-600/80 sm:p-7">
