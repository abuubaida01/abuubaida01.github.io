...
export default function ProjectCard({ project }: { project: Project }) {
  return (
    <div className="group glass flex h-full flex-col p-6 transition-all duration-300 hover:-translate-y-1 hover:border-slate-600/80 hover:shadow-card sm:p-7">
      <div className="flex items-start justify-between">
        <div
          className="flex h-10 w-10 items-center justify-center rounded-lg border border-slate-700/60 bg-ink/60 text-sm font-bold"
        ...
        <div className="flex gap-1.5">
          <a
            ...
            title="Source code"
            className="rounded-lg p-2 text-slate-500 transition-colors hover:text-slate-100"
          >
      ...
      <h3 className="mt-5 text-xl font-semibold text-slate-50">{project.name}</h3>
      <p className="mt-0.5 text-sm font-medium text-indigo-300/90">{project.tagline}</p>
      ...
      <div className="mt-5 flex flex-wrap gap-1.5 border-t border-slate-800/70 pt-4">
